...
import com.arajago6.assessmentapp.OpenGLCubeActivity;
import com.arajago6.assessmentapp.R;
import com.arajago6.assessmentapp.opengl_shared.RawResourceReader;
import com.arajago6.assessmentapp.opengl_shared.ShaderHelper;
import com.arajago6.assessmentapp.opengl_shared.ShapeBuilder;
import com.arajago6.assessmentapp.opengl_shared.TextureHelper;
...
public class OpenGLRenderer implements GLSurfaceView.Renderer {
    ...
    private final OpenGLCubeActivity mLessonSevenActivity;
     ...
     */
    public OpenGLRenderer(final OpenGLCubeActivity lessonSevenActivity, final GLSurfaceView glSurfaceView, final int cubeCount) {
        mLessonSevenActivity = lessonSevenActivity;
        mGlSurfaceView = glSurfaceView;
        mActualCubeFactor = cubeCount;
    }
...
//						Toast.makeText(mLessonSevenActivity, "Out of memory; Dalvik takes a while to clean up the memory. Please try again.\nExternal bytes allocated=" + dalvik.system.VMRuntime.getRuntime().getExternalBytesAllocated(), Toast.LENGTH_LONG).show();
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config)
    {
        ...
        // Load the texture
        mAndroidDataHandle = TextureHelper.loadTexture(mLessonSevenActivity, R.drawable.assessment);
